...
class ChatViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate{
    ...
    @IBAction func sendPressed(_ sender: AnyObject) {
        ...
        messagesDB.childByAutoId().setValue(messageDict){
            ...
            if error != nil{
                print(error!)
                let alert = UIAlertController(title: "Error in sending message. \(error!)", message: "Please Try Again", preferredStyle: .alert)
    ...
    @IBAction func logOutPressed(_ sender: AnyObject) {
        ...
        do{
            ...
            let alert = UIAlertController(title: "Error in signing out.", message: "Please Try Again", preferredStyle: .alert)
            let yesAction = UIAlertAction(title: "Ok", style: .default) { (UIAlertAction) in }
            alert.addAction(yesAction)
